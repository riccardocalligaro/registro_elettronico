...
import 'package:registro_elettronico/ui/bloc/agenda/bloc.dart' as bloc;
...
class _NewEventPageState extends State<NewEventPage> {
  ...
  void _insertEventInDb() async {
    if (_selectedSubject != null) {
      ...
      await RepositoryProvider.of<AgendaRepository>(context).insertLocalEvent(
        AgendaEvent(
          ...
          authorName: "",
          classDesc: "",
          evtId: _selectedDate.millisecondsSinceEpoch,
      ...
      BlocProvider.of<bloc.AgendaBloc>(context).add(bloc.GetAllAgenda());
